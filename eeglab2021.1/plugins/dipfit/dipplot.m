...
h = uicontrol( 'unit', 'normalized', 'position', [0 0.35 .15 .05], 'tag', 'tmp','userdata', 'area', ...
    'style', 'text', 'string', '', 'visible', vis, 'tooltipstring', 'Closest brain area in the Desikan-Killiany Atlas' );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.4 .15 .05], 'tag', 'tmp','userdata', 'z',...
    'style', 'text', 'string', 'Z:', 'visible', vis, 'tooltipstring', 'Talairach coordinate'  );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.45 .15 .05], 'tag', 'tmp','userdata', 'y', ...
    'style', 'text', 'string', 'Y:', 'visible', vis, 'tooltipstring', 'Talairach coordinate'  );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.5 .15 .05], 'tag', 'tmp', 'userdata', 'x',...
    'style', 'text', 'string', 'X:', 'visible', vis, 'tooltipstring', 'Talairach coordinate' );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.55 .15 .05], 'tag', 'tmp', 'userdata', 'rv',...
    'style', 'text', 'string', 'RV:', 'tooltipstring', 'Residual variance in percent' );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.6 .15 .05], 'tag', 'tmp', 'userdata', 'comp', ...
    'style', 'text', 'string', '');
h = uicontrol( 'unit', 'normalized', 'position', [0 0.65 .15 .05], 'tag', 'tmp', 'userdata', 'editor', ...
    'style', 'edit', 'string', '1', 'callback', ...
    [ 'dipplot(gcbf);' ] );
h = uicontrol( 'unit', 'normalized', 'position', [0 0.7 .15 .05], 'tag', 'tmp', ...
...
h = uicontrol( 'unit', 'normalized', 'position', [0 0.75 .15 .05], 'tag', 'tmp', ...
...
h = uicontrol( 'unit', 'normalized', 'position', [0 1 .15 .05], 'tag', 'tmp', ...
    'style', 'text', 'string', '');
...
if exist('foundind')
    ...
    tmprvobj = findobj('parent', fig, 'userdata', 'area'); set( tmprvobj(end), 'string', area, 'fontsize', 8);
end
